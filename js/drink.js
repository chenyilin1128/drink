...
app.controller('mainCtrl', ['$scope',function($scope){
        $scope.list=[
          {imgUrl:' img/p5.jpg',name:'西米露',
            material:'西米包括两类，一种是由棕榈树的核或软核加工而成，一种由木薯块茎提取的' +
            '木薯淀粉制成。两种西米几乎都是纯淀粉，' +
            '西米性温、味甘;有健脾、补肺、亮发、健脑、明目,、益肝、' +
            '治脾胃虚弱和消化不良的作用。',price:"20"}
        ];
        $scope.loadMore=function(){
          $scope.list.push({imgUrl:' img/p6.jpg',name:"西米露",
            material:'西米包括两类，一种是由棕榈树的核或软核加工而成，一种由木薯块茎提取的木薯' +
            '淀粉制成。两种西米几乎都是纯淀粉，' +
            '西米性温、味甘;有健脾、补肺、亮发、健脑、明目,、益肝、治脾胃虚弱和消化不良的作用。',price:"20"})
        }
      }])
   /*   //加载更多
      $scope.loadMore = function () {
...
app.controller('mySettingCtrl',['$scope',function($scope){
  console.log(1);
}])
